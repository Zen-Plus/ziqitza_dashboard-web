  ...
  MIS: {
    ...
    EDS_DASHBOARD: {
      ...
      PRIMARY_COMPLAINT_TILE: {
        ...
        resourceKey: 'MIS.EDS_DASHBOARD.PRIMARY_COMPLAINT_TILE',
      },
      MAP_TILE: {
        key: 'MAP_TILE',
        resourceKey: 'MIS.EDS_DASHBOARD.MAP_TILE',
      },
      TABULAR_DATA_TILE: {
        key: 'TABULAR_DATA_TILE',
        resourceKey: 'MIS.EDS_DASHBOARD.TABULAR_DATA_TILE',
      },
      DISPATCH_TREND_ANALYSIS_TILE: {
        key: 'DISPATCH_TREND_ANALYSIS_TILE',
        resourceKey: 'MIS.EDS_DASHBOARD.DISPATCH_TREND_ANALYSIS_TILE',
      },
      RESPONSE_TIME_ANALYSIS_TILE: {
        key: 'RESPONSE_TIME_ANALYSIS_TILE',
        resourceKey: 'MIS.EDS_DASHBOARD.RESPONSE_TIME_ANALYSIS_TILE',
      },
      ON_ROAD_VEHICLE_ANALYSIS_TILE: {
        key: 'ON_ROAD_VEHICLE_ANALYSIS_TILE',
        resourceKey: 'MIS.EDS_DASHBOARD.ON_ROAD_VEHICLE_ANALYSIS_TILE',
      },
      DROPPED_AT_FACILITY_TILE: {
        key: 'DROPPED_AT_FACILITY_TILE',
        resourceKey: 'MIS.EDS_DASHBOARD.DROPPED_AT_FACILITY_TILE',
      },
    },
  },
};
